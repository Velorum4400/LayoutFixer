...
log must contain `correction watchdog elapsed after 3000 ms`; the next hotkey
...
For 1.3.13, test Insert in ChatGPT when UIA last-word selection is unavailable.
